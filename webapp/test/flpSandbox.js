		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#consultaprod-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"consultaprod-display": {
								"semanticObject": "consultaprod",
								"action": "display",
								"description": "Consulta curso fiori",
								"title": "Consulta de produtos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=consultaprod",
									"url": sap.ui.require.toUrl("consultaprod")
								}
							}
						}
					}
